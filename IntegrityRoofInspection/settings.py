"""
Django settings for IntegrityRoofInspection project.
...
ROOT_URLCONF = 'IntegrityRoofInspection.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'portfolioapp.context_processors.schedule_flow',
                'portfolioapp.context_processors.marketing_ctas'
            ],
        },
    },
]

WSGI_APPLICATION = 'IntegrityRoofInspection.wsgi.application'
